# =====================================================================================
# This script tests integrative_ddm_train.py with low computational demand
# =====================================================================================
...
if checkpoint_exists and history_exists:
    ...
    history = workflow.fit_online(
        epochs=1, # small number for testing purposes
        batch_size=64, 
        num_batches_per_epoch=2, # small number for testing purposes
